...
local logger = hs.logger.new("Links Searcher", "debug")
...
obj.overview = {text="Type l ⇥ to open links", image=hs.image.imageFromPath(obj.spoonPath .. "/resources/justnote.png"), keyword="l"}
...
obj.description = {text="Links Searcher", subText="Search and select one item to copy the source code to clipboard", image=hs.image.imageFromPath(obj.spoonPath .. "/resources/justnote.png")}
...
obj.config = {
    currentOperation = ":openInBrowser",
    allOperations = {
        ":openInBrowser",
        ":copyToClipboard",
    },
